...
import rencontre.dating.looveyou.Activities.ProfileActivity;
import rencontre.dating.looveyou.Activities.ProfileViewActivity;
import rencontre.dating.looveyou.Adapters.CardsAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mGoogleApiClient == null) {
            try {
                ...
                Log.e("Error", "onCreateView: " + ex.getMessage());
            }
        }
