package rencontre.dating.looveyou.Networking;

/**
 * Created by amal on 13/02/17.
 */
public class Endpoints {
    public static String baseUrl = "https://looveyou.com/api/";
    ...
    public static String token_firebase = baseUrl + "notifications/push/register-device";
}
