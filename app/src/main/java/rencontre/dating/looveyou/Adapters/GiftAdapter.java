...
import rencontre.dating.looveyou.Activities.RefillCreditsActivity;
import rencontre.dating.looveyou.Applications.ApplicationSingleTon;
import rencontre.dating.looveyou.Models.Gifts;
...
public class GiftAdapter extends RecyclerView.Adapter<GiftAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(GiftAdapter.MyViewHolder holder, int position) {
        rencontre.dating.looveyou.Models.Gifts gift = Gifts.get(position);
        ...
        public MyViewHolder(View view) {
            ...
            gift_layout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    rencontre.dating.looveyou.Models.Gifts gift = Gifts.get(getAdapterPosition());
